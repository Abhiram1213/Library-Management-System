...
INSERT INTO Books (ISBN, Book_title, Category, Rental_Price, Status, Author, Publisher) VALUES
  ('978-1234567890', 'Introduction to SQL', 'Computer Science', 12.50, 'yes', 'John Smith', 'Tech Publishing'),
  ('978-0984782857', 'Python Crash Course', 'Computer Science', 15.00, 'yes', 'Eric Matthes', 'No Starch Press'),
